    ...
    public class cameraController : MonoBehaviour
    {
       ...
       public bool autoRunReset = false;
        ...
        player = FindObjectOfType<PlayerController>();
            cPlayer = FindObjectOfType<PlayerCombat>();
            player.maincam = this;
            mainCam = Camera.main;
        ...
        void Update()
        {
            ...
            if (Input.GetKey(leftMouse) && !Input.GetKey(rightMouse) && !Input.GetKey(middleMouse)) // if left mouse button is pressed
            {
                cameraState = CameraState.CameraRotate;
            }
            else if (!Input.GetKey(leftMouse) && Input.GetKey(rightMouse) && !Input.GetKey(middleMouse)) // if right mouse button is pressed
